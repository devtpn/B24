# Битрикс24: Кастомизации для коробочной версии

Набор модулей и кастомизаций для Битрикс24 коробочной версии.

## Содержимое

- **crm_email_attachments.php** — Автоматическое извлечение вложений из писем CRM
- **hide-kanban-total/** — Скрытие суммы в канбане CRM
...
|----------|----------|---------------|----------|
| Лид | Файл (Диск) или Файл | Да | `UF_CRM_LEAD_ATTACHMENTS` |
| Сделка | Файл (Диск) или Файл | Да | `UF_CRM_DEAL_ATTACHMENTS` |
| Контакт | Файл (Диск) или Файл | Да | `UF_CRM_CONTACT_ATTACHMENTS` |

**Поддерживаемые типы полей:**
- `disk_file` (Файл Диск) — современный тип, файлы хранятся на диске Битрикс24
- `file` (Файл) — старый тип, файлы хранятся в b_file

Скрипт автоматически определяет тип поля и конвертирует ID файлов при необходимости.
